...
buster.spec.describe("test to html", function() {
  buster.spec.it("with primitive types", function() {
    ...
    a = cljs.core._EQ_.call(null, dalap.html.to_html.call(null, "\ufdd1'symbol"), "symbol");
    b = cljs.core.truth_(null) ? [cljs.core.str(null), cljs.core.str(". ")].join("") : null;
    buster.assert(a, [cljs.core.str(b), cljs.core.str("Expected "), cljs.core.str(cljs.core.list("\ufdd1'=", cljs.core.list("\ufdd1'html/to-html", cljs.core.list("\ufdd1'quote", "\ufdd1'symbol")), "symbol")), cljs.core.str(", got "), cljs.core.str(a)].join(""));
    return null
  });
