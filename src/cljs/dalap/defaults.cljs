...
;;
;; src/clj/dalap/defaults.clj @ Wed Jul 17 12:24:06 PDT 2013
;;
...
(extend-protocol Serializable nil (visit [_ _] "") string (visit [s _] s) number (visit [n _] (str n)) cljs.core/Symbol (visit [o _] (str o)))
