...
;;
;; test/clj/dalap/html/test/escape_test.clj @ Fri Dec 07 20:25:11 UTC 2012
;;
...
(deftest test-gen-str-escaper (it "creates a `str` function successfully" (is (= ((esc/-gen-str-escaper (fn* [p1__1183#] (.toString p1__1183#))) "abc" 123) "abc123") "should behave the same as `clojure.core/str`") (is (= ((esc/-gen-str-escaper (fn* [p1__1184#] (upper-case (.toString p1__1184#)))) "abc" 123) "ABC123") "should be uppercase version of `clojure.core/str`")))
