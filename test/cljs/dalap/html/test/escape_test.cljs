...
;;
;; test/clj/dalap/html/test/escape_test.clj @ Tue Dec 11 20:54:01 UTC 2012
;;
...
(deftest test-gen-str-escaper (it "creates a `str` function successfully" (is (= ((esc/-gen-str-escaper (fn* [p1__1202#] (.toString p1__1202#))) "abc" 123) "abc123") "should behave the same as `clojure.core/str`") (is (= ((esc/-gen-str-escaper (fn* [p1__1203#] (upper-case (.toString p1__1203#)))) "abc" 123) "ABC123") "should be uppercase version of `clojure.core/str`")))
