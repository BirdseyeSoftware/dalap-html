...
;;
;; test/clj/dalap/test/html/escape_test.clj @ Wed Jul 17 12:19:52 PDT 2013
;;
...
(initialize-buster)
(deftest test-gen-str-escaper (it "creates a `str` function successfully" (is (= ((esc/-gen-str-escaper (fn* [p1__1295#] (.toString p1__1295#))) "abc" 123) "abc123") "should behave the same as `clojure.core/str`") (is (= ((esc/-gen-str-escaper (fn* [p1__1296#] (upper-case (.toString p1__1296#)))) "abc" 123) "ABC123") "should be uppercase version of `clojure.core/str`")))
