...
;;
;; test/clj/dalap/test/html/escape_test.clj @ Thu Apr 04 16:30:20 GMT-08:00 2013
;;
...
(deftest test-gen-str-escaper (it "creates a `str` function successfully" (is (= ((esc/-gen-str-escaper (fn* [p1__1281#] (.toString p1__1281#))) "abc" 123) "abc123") "should behave the same as `clojure.core/str`") (is (= ((esc/-gen-str-escaper (fn* [p1__1282#] (upper-case (.toString p1__1282#)))) "abc" 123) "ABC123") "should be uppercase version of `clojure.core/str`")))
